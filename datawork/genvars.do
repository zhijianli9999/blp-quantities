...
sum ratio_j, d
gen aux_highratio = ratio_j > (`r(p50)' * 5) //high nursing home to population ratio, enlarge market
...
sum ratio_t, d
gen aux_highratio = ratio_t > (`r(p50)' * 5)
...
replace fracpop_inmkt = fracpop_inmkt + 0.05 if boostmkt_j==1 | boostmkt_t==1
